...
AppId={{2F11B336-BDE3-4FC9-B7C8-C1923319D9A2}
AppName={#MyAppName}
...
[Registry]
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "RedByteAgent"; ValueData: """{app}\{#MyAppExeName}"""; Flags: uninsdeletevalue
