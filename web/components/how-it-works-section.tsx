...
const steps = [
  {
    ...
    description:
      "Download our app and install it on any Windows computer you want to protect.",
  },
  {
    step: "02",
    icon: Key,
    ...
    description:
      "Get a authentication code from your dashboard and enter it in the app. That's it.",
  },
  {
    step: "03",
    icon: Activity,
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="text-6xl font-semibold text-primary/10 mb-5 tracking-tight">
                {step.step}
              </div>
              <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center mb-5">
                <step.icon className="w-7 h-7 text-primary-foreground" />
              </div>
              <p className="text-xl font-semibold text-foreground mb-3 tracking-tight">
                {step.title}
              </p>
