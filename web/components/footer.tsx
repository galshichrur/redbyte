      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Simple network protection for everyone.
            </p>
          </div>

          {/* GitHub link */}
          <a 
            href="https://github.com/galshichrur/redbyte" 
            target="_blank" 
            rel="noopener noreferrer"
            className="group flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-border hover:border-primary/50 bg-card hover:bg-card/80 transition-all"
          >
            ...
            <span className="text-sm font-medium text-muted-foreground group-hover:text-foreground transition-colors">View on GitHub</span>
          </a>
        </div>
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} RedByte. All rights reserved.
          </p>
